        ...
        <div className="space-y-8 text-stone-600 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mb-4">
              <li>
                <strong>料金体系：</strong>
                無料プラン、Proプラン（月額サブスクリプション）、Premiumプラン（月額サブスクリプション）、回数券があります。詳細は料金プランページをご確認ください。
              </li>
              <li>
                <strong>決済：</strong>
              ...
              <li>
                ...
                サブスクリプション（Pro/Premium）は月単位の自動更新です。解約しない限り、毎月同日に自動的に課金されます。
              </li>
              <li>
                <strong>解約：</strong>
                サブスクリプションはいつでも解約できます。解約後も、現在の請求期間が終了するまでは加入中プランの機能をご利用いただけます。
              </li>
              <li>
                <strong>返金：</strong>
                デジタルサービスの性質上、お客様都合による返金は原則として対応しておりません。法令上必要な場合または当サービスの責による長期システム停止等、利用規約および特定商取引法に基づく表記で定める場合に限り返金対応します。
              </li>
            </ul>
            <p>
              有料サービスに関する詳細は、
