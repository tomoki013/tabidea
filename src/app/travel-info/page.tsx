...
import { FaPassport, FaPlug, FaMoneyBillWave, FaShieldAlt, FaSearch, FaMapMarkedAlt, FaInfoCircle } from "react-icons/fa";
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-2xl border-2 border-stone-200 p-8 space-y-4">
                  ...
                  <div className="space-y-3 text-stone-700">
                    <div>
                      <span className="font-bold">電圧:</span> {travelInfo.power.voltage}
                    </div>
                    <div>
                      <span className="font-bold">周波数:</span> {travelInfo.power.frequency}
                    </div>
                    <div>
                      <span className="font-bold">プラグタイプ:</span> {travelInfo.power.plugType}
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    ...
                    {travelInfo.safety.warnings.length > 0 && (
                      <div className="bg-orange-50 border border-orange-200 rounded-xl p-4">
                        <p className="font-bold text-orange-800 mb-2">⚠️ 注意点:</p>
              ...
              <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-[#2c2c2c] mb-1">ビザの要否</h3>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-[#2c2c2c] mb-1">電源形状</h3>
                      <p className="text-stone-600 text-sm">
                        電圧、周波数、プラグタイプの確認
                      </p>
                    </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-[#2c2c2c] mb-1">チップ文化</h3>
                      <p className="text-stone-600 text-sm">
                        その国のチップの習慣や相場
                      </p>
                    </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-[#2c2c2c] mb-1">治安情報</h3>
                      <p className="text-stone-600 text-sm">
                        一般的な治安状況と注意点
                      </p>
                    </div>
