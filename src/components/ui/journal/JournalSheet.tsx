...
export const JournalSheet = React.forwardRef<HTMLDivElement, JournalSheetProps>(
  ({ children, variant = "default", className, ...props }, ref) => {
    const baseStyles = "bg-[#fcfbf9] dark:bg-card relative shadow-md border border-stone-200 dark:border-stone-800";
    ...
    const variants = {
      ...
      notebook: "rounded-r-md rounded-l-sm border-l-4 border-l-stone-300 dark:border-l-[rgba(110,86,69,0.5)] p-6 bg-[linear-gradient(to_bottom,#e5e7eb_1px,transparent_1px)] dark:bg-[linear-gradient(to_bottom,rgba(110,86,69,0.1)_1px,transparent_1px)] bg-[size:100%_2rem]",
    };
