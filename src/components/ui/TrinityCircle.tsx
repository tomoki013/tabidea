...
export default function TrinityCircle() {
  return (
    <div className="flex flex-col items-center justify-center py-8">
      {/* Circles Container */}
      <div className="relative flex items-center justify-center w-full max-w-[500px] h-[280px] sm:h-[320px]">
        ...
        <motion.div
          ...
          className="absolute left-0 sm:left-4 w-40 h-40 sm:w-56 sm:h-56 rounded-full border-4 border-[#e67e22] bg-[#e67e22]/5 flex flex-col items-center justify-center text-center p-4 z-10"
        >
        ...
        <motion.div
          ...
          className="absolute right-0 sm:right-4 w-40 h-40 sm:w-56 sm:h-56 rounded-full border-4 border-[#27ae60] bg-[#27ae60]/5 flex flex-col items-center justify-center text-center p-4 z-10"
        >
        ...
        {/* Center Intersection: Deai */}
        {/* We position this in the center. The overlapping transparency might create a color, but we want explicit text.
            We place a "pin" or a focused area in the absolute center. */}
        <motion.div
        ...
        >
          <div className="relative flex flex-col items-center justify-center w-28 h-28 sm:w-36 sm:h-36 bg-white/80 backdrop-blur-sm rounded-full shadow-lg border-2 border-[#f1c40f]">
