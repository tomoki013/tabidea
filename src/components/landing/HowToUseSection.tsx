...
const steps = [
  {
    number: "1",
    title: "行き先を選ぶ",
    description: "まずは、行きたい場所を入力します。具体的な都市名でも、「暖かい場所」「自然が豊かなところ」といった漠然としたイメージでも大丈夫です。",
    tips: [
      "複数の候補地を入力することも可能",
      "地域や国で指定してもOK",
  ...
  },
  {
    number: "2",
    title: "旅行の詳細を設定",
    description: "日程、予算、同行者、旅のテーマなど、旅行の詳細情報を入力していきます。対話形式で進むので、まるで友達と話しているような感覚です。",
    tips: [
      "日程は大まかな期間でも構いません",
      "予算は総額または1日あたりの金額で設定",
  ...
  },
  {
    number: "3",
    title: "AIがプランを生成",
    description: "入力した情報をもとに、AIが旅行プランを作成します。観光スポット、移動手段、所要時間などが含まれた、実行可能なプランが数秒で完成します。",
    tips: [
      "生成には10〜30秒程度かかります",
      "複数の候補プランから選べる場合も",
      "天候や季節も考慮されています"
  ...
  },
  {
    number: "4",
    title: "プランをカスタマイズ",
    description: "生成されたプランを自由に編集できます。スポットの追加・削除、順番の入れ替え、時間の調整など、完璧な旅行プランに仕上げましょう。",
    tips: [
      "気になるスポットをタップして詳細を確認",
  ...
  },
  {
    number: "5",
    title: "プランを保存・共有",
    description: "完成したプランは保存して、いつでも見返すことができます。また、旅行仲間とプランを共有することも可能です。",
    tips: [
      "URLをコピーして簡単に共有",
      "PDFでダウンロードすることも可能",
      "修正したい場合はいつでも編集できます"
...
const usageTips = [
  {
    title: "具体的な希望を伝える",
    description: "「美術館に行きたい」「現地の食べ物を楽しみたい」など、具体的な希望を伝えるほど、より精度の高いプランが生成されます。"
  },
  {
    title: "何度でも再生成できる",
    description: "生成されたプランが気に入らなければ、何度でも再生成できます。条件を少し変えて、理想のプランを見つけましょう。"
  },
  {
    title: "チャットで微調整",
    description: "プラン生成後、AIとチャットで対話しながら細かい調整ができます。「もっと静かな場所がいい」といったリクエストにも対応します。"
  },
  {
    title: "フリーテキストで入力",
    description: "「朝はゆっくり過ごしたい」「子供連れなので疲れない行程で」など、フリーテキストで細かい要望を伝えることもできます。"
  }
];
              ...
              >
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <div className="bg-primary/5 rounded-lg p-4 space-y-2">
                    <p className="text-sm font-bold text-primary">💡 ポイント</p>
