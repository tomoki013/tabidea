...
export default function MapRouteView({
  ...
  return (
    <div className={`w-full rounded-xl overflow-hidden border border-stone-200 shadow-sm bg-white flex flex-col ${className}`}>
      {/* Header */}
      <button
        ...
        <>
          {allMarkers.length > 0 ? (
            <>
              ...
              {/* Map */}
              <MapErrorBoundary className="w-full flex-1 min-h-[300px]">
