...
export default function ConceptSection() {
  const t = useTranslations("components.extraUi.landingV2ConceptSection");
            ...
            <div className="bg-white/60 backdrop-blur-sm p-6 rounded-2xl border border-stone-100 shadow-sm text-left relative overflow-hidden">
               ...
               <p className="text-stone-700 font-medium leading-loose text-sm md:text-base">
                  {t.rich("descriptionRich", {
                    brand: (chunks) => <span className="font-bold text-[#e67e22]">{chunks}</span>,
                    deai: (chunks) => <span className="font-bold text-[#d35400]">{chunks}</span>,
                    idea: (chunks) => <span className="font-bold text-[#27ae60]">{chunks}</span>,
                    tabi: (chunks) => <span className="font-bold text-[#e67e22]">{chunks}</span>,
                  })}
               </p>
            </div>
          </motion.div>
