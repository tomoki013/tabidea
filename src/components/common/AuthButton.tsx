...
import { FaUser, FaMapMarkedAlt, FaSignOutAlt, FaChevronDown, FaCog } from 'react-icons/fa';
          ...
          <div className="absolute right-0 mt-3 w-64 bg-[#fcfbf9] rounded-xl shadow-xl border-2 border-dashed border-[#e67e22]/20 py-2 z-50 overflow-hidden">
            ...
            <div className="py-2">
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-stone-700 hover:bg-[#e67e22]/5 hover:text-[#e67e22] transition-colors group"
              >
                <FaCog className="text-[#e67e22]/50 group-hover:text-[#e67e22] transition-colors" />
