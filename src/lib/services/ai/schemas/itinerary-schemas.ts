...
export const ActivityInputSchema = z.object({
  ...
  searchQuery: z.string().optional().nullable().describe('Google Places API検索に最適化された英語の正式名称（例: "Kinkaku-ji Temple", "Ichiran Ramen Shibuya"）'),
  locationEn: z.string().optional().describe('英語での場所名（例: "Kyoto, Japan"）— Places API地域フィルタ用'),
  ...
  source: FlexibleSourceSchema.optional().nullable().describe('情報源'),
});
