...
export const CACHE_TTL_CONFIG: Record<TravelInfoCategory, number> = {
  ...
  technology: 24 * 60 * 60 * 1000, // 24時間（通信環境等は変化の可能性あり）
  healthcare: 7 * 24 * 60 * 60 * 1000, // 7日（医療機関は安定的）
  restrooms: 30 * 24 * 60 * 60 * 1000, // 30日（設備は不変）
  smoking: 30 * 24 * 60 * 60 * 1000, // 30日（ルールは安定的）
  alcohol: 30 * 24 * 60 * 60 * 1000, // 30日（ルールは安定的）
};
