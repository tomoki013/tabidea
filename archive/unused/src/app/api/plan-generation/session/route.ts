  ...
  try {
    ...
    await updateSession(session.id, {
      ...
      pipelineContext: {
        ...
        runtimeProfile: body.constraints?.runtimeProfile,
        costProfile: body.constraints?.costProfile,
        threadId: body.threadId,
        tripId: body.tripId,
        replanScope: body.replanScope ?? null,
        idempotencyKey: body.idempotencyKey,
        memoryEnabled: body.memoryEnabled,
        memorySnapshot: body.memorySnapshot ?? null,
      },
    });
    await runEventService.appendEvent(session.id, 'run.started', {
